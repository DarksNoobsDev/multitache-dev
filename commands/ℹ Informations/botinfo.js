...
module.exports.run = async (client, message, args) => {
 ...
 .addField(`**__❱ Dévéloppeurs :__**`, `<@${info.ownerIds.join(", ")}> \n${info.ownerPseudo.join(", ")}`, true)
 ...
 .addField(`**__❱ Avec :__**`, `**${client.commands.size}** commandes, et **6** catégories!`,true)
 .addField(`**__❱ Discord officiel :__**`, `[\`Lien du discord\`](https://www.discord.gg/LOLPROs)`,true)
